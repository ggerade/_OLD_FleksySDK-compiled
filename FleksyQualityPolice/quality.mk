...
ASSETS_LANGUAGES = bg-BG cs-CZ da-DK de-DE el-GR en-US es-ES et-EE fi-FI fr-FR hr-HR hu-HU it-IT lt-LT ms-MY nb-NO nl-NL pl-PL pt-BR pt-PT ro-RO ru-RU sk-SK sv-SE uk-UA tr-TR
...
$(ASSETS_LANGUAGES): FleksyTester.jar
	@/usr/bin/perl -C -e '$$FQP=`java -Xmx2048M -jar FleksyTester.jar $(FQP_ARGS) -loc:$@ 2>&1`; @lines = split(/\n/,$$FQP); if($$#lines > 0) { print("vvvvv $@ vvvvv\n" . $$FQP . "^^^^^ $@ ^^^^^^\n"); } else { print $$FQP; }'
